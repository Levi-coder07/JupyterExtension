...
# Change directory to the LinkMaker directory
...
jupyter server extension disable LinkMaker
...
folder is located. Then you can remove the symlink named `LinkMaker` within that folder.
